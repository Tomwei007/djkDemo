var FormComponents = function () {
    ...
    var handleSpinners = function () {
        ...
        $('#spinner3').spinner({value:4, min: 3, max: 10});
    ...
    var handleDateRangePickers = function () {
        ...
        $('#reportrange').daterangepicker({
                ...
                locale: {
                    ...
                    monthNames: ['January', 'February', 'March', 'April', 'May', 'June', '七月', 'August', 'September', 'October', 'November', 'December'],
                    firstDay: 1
                }
            },
            function (start, end) {
    ...
    var handleInputMasks = function () {
        ...
        $("#mask_date").inputmask("y/m/d h:m", {
            autoUnmask: true
        }); //direct mask 
		$("#mask_date-1").inputmask("y/m/d h:m", {
            autoUnmask: true
        }); //direct mask 
		$("#mask_date-2").inputmask("y/m/d h:m", {
            autoUnmask: true
        }); //direct mask 
		$("#mask_date-3").inputmask("y/m/d h:m", {
            autoUnmask: true
        }); //direct mask 
		$("#mask_date-4").inputmask("y/m/d h:m", {
            autoUnmask: true
        }); //direct mask        
